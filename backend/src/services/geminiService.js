 ...
 */
export const detectDominantLanguage = (message = '', requestedLanguage = 'en') => {
 ...
 */
export const buildContextTag = (context = {}, language = 'en') => {
 ...
 */
export const generateActionSuggestions = (context = {}, language = 'en') => {
  if (language === 'gu') {
    return [
 ...
 */
export const validateGrounding = (replyText = '', context = {}) => {
 ...
 */
export const generateAssistantResponse = async ({ message, language = 'en', context = {} }) => {
...
${endInstruction}`;
  ...
  try {
    ...
    clearTimeout(timeoutId);
    logger.warn(`Gemini fetch error: ${err.message}. Activating safe grounded engine.`);
  }
