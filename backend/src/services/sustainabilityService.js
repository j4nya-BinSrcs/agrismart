...
import irrigationService, { IRRIGATION_EFFICIENCIES } from './irrigationService.js';
 ...
 */
const validateDateString = (dateStr, paramName = 'date') => {
 ...
 */
const getMethodEfficiency = (method = '') => {
...
export const sustainabilityService = {
   ...
   */
  async getSustainabilitySummary(userId, options = {}) {
    ...
    try {
      ...
      logger.warn(`Sustainability service irrigation engine evaluation warning: ${err.message}`);
    }
