    ...
    <div className="space-y-5 max-w-5xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-3 border-b border-slate-200">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-md bg-white border border-slate-200 text-slate-700 hover:bg-slate-50 transition-colors cursor-pointer shrink-0"
        >
      ...
      <div className="rounded-lg border border-slate-200 bg-white p-5">
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-5">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 rounded-md bg-emerald-800 text-white flex flex-col items-center justify-center shrink-0">
              <span className="text-2xl font-bold font-sans leading-none">
                {metrics.overallScore}
              </span>
              <span className="text-[10px] uppercase font-medium tracking-wider text-emerald-200 mt-0.5">
                / 100
              </span>
            </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-0.5">
                ...
                <span className="inline-flex items-center gap-1 text-[11px] text-emerald-800 font-medium bg-emerald-50 border border-emerald-200 px-1.5 py-0.5 rounded">
          ...
          <div className="w-full md:w-auto flex flex-col md:items-end shrink-0 pt-2 md:pt-0 border-t md:border-t-0 border-slate-100">
            <span className="text-[11px] text-slate-400">Benchmark comparison</span>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-4 flex flex-col justify-between">
          <div>
            ...
            <div className="text-2xl font-semibold text-slate-900 font-sans mb-1">
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-4 flex flex-col justify-between">
          ...
          <div className="mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
            ...
            <span className="font-medium text-slate-700">{metrics.runoffPreventedKg} kg Active</span>
          </div>
        </div>
        ...
        <div className="bg-white border border-slate-200 rounded-lg p-4 flex flex-col justify-between">
          ...
          <div className="mt-3 pt-2.5 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
            ...
            <span className="font-medium text-slate-700">0.72% (Target 0.8%)</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-emerald-50/70 border border-emerald-200 rounded-lg p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <div className="flex items-start gap-3">
          <div className="p-2 rounded bg-emerald-100 text-emerald-800 shrink-0 mt-0.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-[10px] font-semibold bg-emerald-100 text-emerald-900 px-2 py-0.2 rounded">
                14,200 L Total
              </span>
            </div>
        ...
        <div className="flex items-center gap-2 shrink-0">
          <button
            ...
            className="px-3 py-1.5 text-xs font-medium rounded-md bg-white border border-emerald-300 text-emerald-900 hover:bg-emerald-50 transition-colors cursor-pointer"
          >
            Explain Connection
          </button>
          <button
            ...
            className="px-3 py-1.5 text-xs font-medium rounded-md bg-emerald-800 text-white hover:bg-emerald-900 transition-colors cursor-pointer inline-flex items-center gap-1"
          >
      ...
      <div className="bg-white border border-slate-200 rounded-lg p-5 space-y-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div
            onClick={() => setShowWaterConnectionModal(true)}
            className="p-3.5 rounded-md bg-slate-50 border border-slate-200 hover:border-emerald-300 transition-colors cursor-pointer group"
          >
            <div className="flex items-center justify-between">
              <div className="text-[10px] font-medium text-slate-500 uppercase">Estimated Water Saved</div>
              <ExternalLink className="w-3 h-3 text-slate-400 group-hover:text-emerald-700 transition-colors" />
            </div>
            <div className="text-xl font-semibold text-slate-900 font-sans my-1">
              {metrics.waterSavedMonthLitres.toLocaleString()} L
            </div>
            <p className="text-[11px] text-slate-600 leading-relaxed">
              Achieved by delaying irrigation pump cycles ahead of natural precipitation events. <span className="text-emerald-800 font-medium underline">Inspect link</span>
            </p>
          </div>

          <div className="p-3.5 rounded-md bg-slate-50 border border-slate-200">
            <div className="text-[10px] font-medium text-slate-500 uppercase">Carbon Offset (Pumping Power)</div>
            <div className="text-xl font-semibold text-slate-900 font-sans my-1">
          ...
          <div className="p-3.5 rounded-md bg-slate-50 border border-slate-200">
            <div className="text-[10px] font-medium text-slate-500 uppercase">Chemical Runoff Prevented</div>
            <div className="text-xl font-semibold text-slate-900 font-sans my-1">
      ...
      <div className="bg-white border border-slate-200 rounded-lg p-5 space-y-3">
        ...
        <div className="space-y-2">
          {metrics.improvements.map((imp) => (
            <div
              key={imp.id}
              className="p-3 rounded-md border border-slate-200 bg-slate-50 hover:bg-slate-100/60 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-2.5"
            >
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-0.5">
                  <h4 className="text-xs font-semibold text-slate-900">{imp.title}</h4>
                  <span className="text-[10px] font-medium text-slate-600 bg-white border border-slate-200 px-1.5 py-0.2 rounded">
                    {imp.category}
                  </span>
                </div>
                <p className="text-xs text-slate-600">{imp.impact}</p>
              </div>
      ...
      {showCalculationModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur-xs">
          <div className="relative bg-white rounded-xl max-w-lg w-full p-5 shadow-xl z-10 border border-slate-200 space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div>
                <h3 className="font-semibold text-sm text-slate-900">
                  How is the Sustainability Score Calculated?
                </h3>
                <p className="text-xs text-slate-500">Transparent mathematical derivation from farm telemetry</p>
              </div>
              <button
                type="button"
            ...
            <div className="space-y-3 text-xs text-slate-600 leading-relaxed">
              <div className="p-3 rounded-md bg-slate-50 border border-slate-200">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-semibold text-slate-900">1. Water Efficiency Factor</span>
                  <span className="font-bold text-emerald-800">92 / 100 (Weight: 40%)</span>
                </div>
                ...
                <div className="text-[11px] text-slate-500 font-mono mt-1 bg-white p-1 rounded border border-slate-200">
              ...
              <div className="p-3 rounded-md bg-slate-50 border border-slate-200">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-semibold text-slate-900">2. Chemical Reduction & Runoff</span>
                  <span className="font-bold text-emerald-800">78 / 100 (Weight: 30%)</span>
                </div>
                <p className="text-[11px] text-slate-600">
              ...
              <div className="p-3 rounded-md bg-slate-50 border border-slate-200">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-semibold text-slate-900">3. Soil Health & Compaction Index</span>
                  <span className="font-bold text-emerald-800">81 / 100 (Weight: 30%)</span>
                </div>
                <p className="text-[11px] text-slate-600">
              ...
              <div className="p-2.5 rounded bg-emerald-50 border border-emerald-200 flex items-center justify-between text-xs font-semibold text-emerald-900">
            ...
            <div className="pt-3 border-t border-slate-100 flex justify-end">
              <button
                type="button"
                onClick={() => setShowCalculationModal(false)}
                className="px-3.5 py-1.5 bg-emerald-800 text-white text-xs font-medium rounded-md hover:bg-emerald-900 cursor-pointer"
              >
                Understood
              </button>
            </div>
          ...
          <div className="relative bg-white rounded-xl max-w-lg w-full p-5 shadow-xl z-10 border border-slate-200 space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-slate-100">
              <div>
                ...
                <p className="text-xs text-slate-500">Cross-system synergy: Weather + Soil Telemetry + Pumping Control</p>
              </div>
              <button
                type="button"
