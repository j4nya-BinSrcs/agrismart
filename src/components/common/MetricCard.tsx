...
export const MetricCard: React.FC<MetricCardProps> = ({
  ...
  return (
    ...
    >
      ...
      {actionText && (
        <div className="pt-2.5 border-t border-slate-100 mt-3 flex items-center justify-between text-xs">
          <span className="text-emerald-800 font-medium">{actionText}</span>
          {onClickAction && (
            <button
              type="button"
