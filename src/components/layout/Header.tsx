...
export const Header: React.FC<HeaderProps> = ({
  ...
  const [selectedFarm, setSelectedFarm] = useState(`${displayFarm} (${displayLocation})`);
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="px-2 py-1 text-xs text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white flex items-center gap-1 rounded-md hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors cursor-pointer"
          ...
          {/* Farmer User Profile, Reset Demo & Logout Menu */}
          <div className="relative">
            <button
              type="button"
              onClick={() => setShowUserMenu(!showUserMenu)}
              className="flex items-center gap-1.5 pl-2 border-l border-slate-200 dark:border-slate-800 text-xs cursor-pointer hover:text-slate-900 dark:hover:text-white transition-colors py-1"
              aria-label="User settings"
            >
              <span className="w-6 h-6 rounded-full bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 flex items-center justify-center font-medium text-[11px]">
                {initials}
              </span>
              <span className="font-medium text-slate-900 dark:text-slate-200 max-w-[110px] truncate hidden sm:inline">
                {displayName}
              </span>
              <ChevronDown className="w-3 h-3 text-slate-400 dark:text-slate-500" />
            </button>
            ...
            {showUserMenu && (
              <>
                ...
                />
                <div className="absolute right-0 mt-1.5 w-56 rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-lg p-1.5 z-20">
                  ...
                  {onResetDemo && (
                    <button
                      ...
                      className="w-full text-left px-2.5 py-2 mt-1 rounded-md text-xs text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white hover:bg-slate-50 dark:hover:bg-slate-800 flex items-center gap-2 transition-colors cursor-pointer"
                    >
                  ...
                  <button
                    ...
                    className="w-full text-left px-2.5 py-2 mt-1 rounded-md text-xs text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/30 flex items-center gap-2 transition-colors cursor-pointer"
                  >
          ...
          <button
            ...
            className="px-2 py-1 rounded-md text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 border border-rose-200 dark:border-rose-900/60 transition-colors cursor-pointer flex items-center gap-1.5 text-xs font-medium shrink-0"
