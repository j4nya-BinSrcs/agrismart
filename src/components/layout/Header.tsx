    ...
    <header className="sticky top-0 z-30 bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 transition-colors">
      <div className="px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          {/* Farmer User Profile & Reset Demo Menu */}
          <div className="relative">
            <button
              type="button"
              onClick={() => setShowUserMenu(!showUserMenu)}
              className="hidden sm:flex items-center gap-1.5 pl-2 border-l border-slate-200 dark:border-slate-800 text-xs cursor-pointer hover:text-slate-900 dark:hover:text-white transition-colors py-1"
            ...
            >
              ...
              <span className="font-medium text-slate-900 dark:text-slate-200">R. Patel</span>
              <ChevronDown className="w-3 h-3 text-slate-400 dark:text-slate-500" />
            </button>
            ...
            {showUserMenu && (
              <>
                ...
                />
                <div className="absolute right-0 mt-1.5 w-52 rounded-lg bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-lg p-1.5 z-20">
                  <div className="px-2.5 py-2 border-b border-slate-100 dark:border-slate-800">
                    <div className="font-semibold text-xs text-slate-900 dark:text-slate-100">Ramesh Patel</div>
                    <div className="text-[11px] text-slate-500 dark:text-slate-400">Patel Farm • Anand</div>
                  </div>
                  ...
                  {onResetDemo && (
                    <button
                      ...
                      className="w-full text-left px-2.5 py-2 mt-1 rounded-md text-xs text-slate-700 dark:text-slate-300 hover:text-rose-700 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/30 flex items-center gap-2 transition-colors cursor-pointer"
                    >
