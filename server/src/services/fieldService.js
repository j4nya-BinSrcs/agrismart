...
export const fieldService = {
   ...
   */
  async createField(userId, farmId, data = {}) {
   ...
   */
  async getFieldsByFarm(userId, farmId) {
    validateObjectId(userId, 'User ID');
    validateObjectId(farmId, 'Farm ID');
   ...
   */
  async getFieldById(userId, farmId, fieldId) {
    validateObjectId(userId, 'User ID');
    validateObjectId(farmId, 'Farm ID');
   ...
   */
  async updateField(userId, farmId, fieldId, updateData = {}) {
    validateObjectId(userId, 'User ID');
    validateObjectId(farmId, 'Farm ID');
    validateObjectId(fieldId, 'Field ID');
   ...
   */
  async deleteField(userId, farmId, fieldId) {
    validateObjectId(userId, 'User ID');
    validateObjectId(farmId, 'Farm ID');
    validateObjectId(fieldId, 'Field ID');
